...
let rec imposingWill : ArchetypeDef = {
    ...
    Name = "Imposing Will"
    Grants = [ Passive.Simple "Gain a +2 bonus to your Difficulty Class when casting Spells or applying conditions." ]
}
...
let rec reactiveRetribution : ArchetypeDef = {
    ...
    Grants = [ Passive.Simple "When an ally is damaged, you may expand your reaction to make a melee-based Attack Roll against their aggressor." ]
}
