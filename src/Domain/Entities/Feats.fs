...
let rec shieldbearer : FeatDef = {
    ...
    Grants = [
        ...
        Complex("PassiveFeature_MultiattackDefense" <!!> "Shieldbearer: Charges", "Gain 3 Shieldbearer Charges to negate damage instances (recharge on Short Rest/Kill/Critical hit).")
...
let rec warCaster : FeatDef = {
    ...
    Grants = [
        ...
        Power(BonusAction, AtWill, "Bind Weapons", "Bind Weapons: use Spellcasting Ability for Attack Rolls and Damage. Killing another creature or landing a Critical hit restores a level 1 Spell Slot.")
