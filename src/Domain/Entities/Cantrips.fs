...
let rec ``Blade Surge`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d12 Force Damage in a 3 m area around you. On Saving Throw targets still take half damage. Duration: 1 turn. Offense: DEX Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Druidcraft`` : CantripDef = {
    ...
    CantripDescription = "Attempt to Entangle another creature, leaving them unable to move. Attack Rolls against the creature also have Advantage and they make all Dexterity based Saving Throws with Disadvantage. Duration: 1 turn. Offense: STR Saving Throw."
    Concentration = false
    ActionCost = BonusAction
}
...
let rec ``Guiding Moonlight (Light)`` : CantripDef = {
    Id = % nameof ``Guiding Moonlight (Light)``
...
let rec ``Gust Bellow`` : CantripDef = {
    ...
    CantripDescription = "Expel a blast of wind around yourself removing any nearby surfaces and potentially forcing creatures back by 9 m. Offense: STR Saving Throw."
    Concentration = false
    ActionCost = BonusAction
}
...
let rec ``Mind Sliver`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d8 Psychic Damage to a creature, potentially Fracturing their ability to think clearly. This causes them to suffer a 1d4 penalty to their next Saving Throw alongside not being able to utlize their armours elemental Damage Reduction. Duration: 3 turns. Offense: INT Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Poison Spray`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d8 Poison Damage to target creature. Additional damage will occur to any Poisoned enemies. Duration: 1 turn. Offense: CON Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Spark Surge`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d8 Lightning Damage to a target, potentially Shocking them. This causes them to be unable to use Reactions and have Disadvantage on Dexterity based Ability Checks and Saving Throws. Duration: 1 turn. Offense: DEX Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Thorn Whip`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d8 Piercing Damage and potentially pull a creature 9 m closer to you. Cannot pull targets if their size is classified as Huge. Offense: STR Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Thunderclap`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d12 Thunder Damage in an area around you. On Saving Throw, targets still take half the damage. Duration: 1 turn. Offense: CON Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Toll the Dead`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d8 Necrotic Damage to a target. If the target is below half of their total Hit Points this Cantrip deals double damage. On Saving Throw, the target still takes half the damage. Offense: WIS Saving Throw."
    Concentration = false
    ActionCost = Action
}
...
let rec ``Vicious Mockery`` : CantripDef = {
    ...
    CantripDescription = "Target an enemy to potentially cause their Attack Rolls to be made with Disadvantage until the end of their turn. Duration: 1 turn. Offense: WIS Saving Throw."
    Concentration = false
    ActionCost = BonusAction
}
...
let rec ``Word of Radiance`` : CantripDef = {
    ...
    CantripDescription = "Deal 1d12 Radiant Damage in an area around you. Deals double damage to Aberrations, Fey, Fiends and Undead. On Saving Throw, targets still take half the damage. Offense: CON Saving Throw."
    Concentration = false
    ActionCost = Action
}
