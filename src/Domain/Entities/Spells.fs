...
let ensnaringTrap =
    { Id = % "ensnaring-trap"
      Name = "Ensnaring Trap"
      SpellDescription = "Place 3 traps. Restrain targets on failed save."
      SpellLists = [ Primal; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let feignDeath =
    { Id = % "feign-death"
      Name = "Feign Death"
      SpellDescription = "Target allies in 3m AOE are put to sleep but become resistant to all damage"
      SpellLists = [ Divine; Innate ]
      Concentration = true
      Upcastable = true
      ActionCost = BonusAction }
...
let healingGlyph =
    { Id = % "healing-glyph"
      Name = "Healing Glyph"
      SpellDescription = "Heal 1d12+4 on target when concentration is broken"
      SpellLists = [ Divine; Primal ]
      Concentration = true
      Upcastable = true
      ActionCost = BonusAction }
...
let shadowBlade = {
    Id = % "shadow-blade"
    Name = "Shadow Blade"
    SpellDescription = "Illusion Blade 1d12 Psychic damage. In Heavily Obscured area, deal max damage. All attacks roll with advantage"
    SpellLists = [Arcane]
    Concentration = false
    Upcastable = false
    ActionCost = BonusAction
