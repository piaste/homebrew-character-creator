...
let phantasmalKiller =
    { Id = % "phantasmalKiller"
      ...
      SpellDescription = "Deal 1d6 psychic dmg each turn, target movement is halfd. Save at the end of each round"
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let powerOverEvilGood =
    { Id = % "powerOverEvilGood"
...
let wallOfIce =
    { Id = % "wallOfIce"
      Name = "Wall of Ice"
      SpellDescription = "Create a wall made of solid ice that lasts until long rest or until broken. Once broken, frigid air seeps out of the wall and halfs the Movmement Speed of all creatures within. Creatures may also be Frozen for 1 Turn."
      SpellLists = [ Divine; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
