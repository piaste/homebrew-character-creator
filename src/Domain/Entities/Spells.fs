...
let armsOfHadar =
    { Id = % "arms-of-hadar"
      Name = "Arms of Hadar"
      SpellDescription = "Deal 1d12(+4) Necrotic Damage in a 3 m area around the caster applying a condition that prevents creatures from using Reactions. On Saving Throw, the target still takes half the damage."
...
let blight =
    { Id = % "blight"
      Name = "Blight"
      SpellDescription = "Deal 1d12(+4) Necrotic Damage to a target creature. If the target is Undead they have Disadvantage on the Saving Throw against this Spell. On Saving Throw the target still takes half the damage."
...
let fireball =
    { Id = % "fireball"
      Name = "Fireball"
      SpellDescription = "Deal 1d6+4 fire Damage in a large AOE and burn targets until Helped on failed Saving Throw On Saving Throw: Half damage."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let flamingSphere =
    { Id = % "flaming-sphere"
      Name = "Flaming Sphere"
      SpellDescription = "Create a flaming sphere doing 1d6 fire Damage/round On Saving Throw: half damage."
      SpellLists = [ Primal; Innate ]
      Concentration = true
      Upcastable = true
      ActionCost = BonusAction }
...
let fleshToStone =
    { Id = % "flesh-to-stone"
      Name = "Flesh to Stone"
      SpellDescription = "At the end of each turn, target make a Saving Throw. After 6 turns, become petrified permanently. Your target has disadvantage on DEX Saving Throw."
      SpellLists = [ Innate; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let grease =
    { Id = % "grease"
      Name = "Grease"
      SpellDescription = "Create a 2m AOE surface slowing creatures (no Saving Throw) and knocking them prone on failed Saving Throw."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let gustOfWind =
    { Id = % "gust-of-wind"
      Name = "Gust of Wind"
      SpellDescription = "Clear all clouds and push back all targets around you 3m, inflicting Prone with no Saving Throw."
      SpellLists = [ Primal; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let harm =
    { Id = % "harm"
      Name = "Harm"
      SpellDescription = "1d12 +4 Damage 18m range On Saving Throw: half damage. Heal Undead creatures."
      SpellLists = [ Divine; Primal ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let holdCreature =
    { Id = % "hold-creature"
      Name = "Hold Creature"
      SpellDescription = "Target creature can't act on failed Saving Throw. Attacks made against them within 3m will always be critical hit. Target breaks free after 1 attack."
      SpellLists = [ Divine; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let hungerOfHadar =
    { Id = % "hunger-of-hadar"
      ...
      SpellDescription = "Create a large AOE blinding creatures inside. They take 1d6 cold damage on failed Saving Throw when they start their turn inside, they take 1d6 acid damage on failed Saving Throw when ending their turn inside."
      SpellLists = [ Bargained; Arcane ]
      Concentration = true
      Upcastable = true
      ActionCost = Action }
...
let hypnoticPattern =
    { Id = % "hypnotic-pattern"
      ...
      SpellDescription = "Target creature can't move or notice your presence on failed Saving Throw."
      SpellLists = [ Innate; Arcane ]
      Concentration = true
      Upcastable = true
      ActionCost = Action }
...
let iceKnife =
    { Id = % "ice-knife"
      Name = "Ice Knife"
      SpellDescription = "Deal 1d12+4 cold damage.On hit another projectile will spawn from target which seeks out another enemy within 9m. Splinter will do 5-10 cold damage. On Saving Throw: half damage."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let iceStorm =
    { Id = % "ice-storm"
      Name = "Ice Storm"
      SpellDescription = "Deal 1d6+4 cold damage in a 3m AOE. Create an icy surface and apply 3 turns of Frigid. On Saving Throw: half damage. Every subsequent turn while you maintain concentration, you can recast the spell as a free action."
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let inflictWounds =
    { Id = % "inflict-wounds"
      Name = "Inflict Wounds"
      SpellDescription = "Deal 1d12+4 poison damage on hit (melee range) and Cripple target (no Saving Throw)."
      SpellLists = [ Divine; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let insectPlague =
    { Id = % "insect-plague"
      Name = "Insect Plague"
      SpellDescription = "Cover a 9 m area in Locusts that will attack all within it's domain. Creatures who enter may receive the conditions Bleeding and/or Gaping Wounds depending on their CON Saving Throw."
      SpellLists = [ Primal; Bargained ]
      Concentration = false
      Upcastable = false
      ActionCost = Action }
...
let lightningBolt =
    { Id = % "lightning-bolt"
      Name = "Lightning Bolt"
      SpellDescription = "Deal 1d6+4 lightning damage in a huge line On Saving Throw: half damage."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let maximiliansEarthenGrasp =
    { Id = % "maximilians-earthen-grasp"
      ...
      SpellDescription = "Deal 1d12+4 bludgeoning Damage and Restrain target on Saving Throw On Saving Throw: half damage."
      SpellLists = [ Primal; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let otilukeResilientSphere =
    { Id = % "otiluke-resilient-sphere"
      ...
      SpellDescription = "Enclose a target in a sphere, make it invulnerable but unable to deal agressive actions. Saving Throw each round. Reduce movement speed by half. 3m range. Target cannot be huge size."
      SpellLists = [ Divine; Arcane ]
      Concentration = true
      Upcastable = true
      ActionCost = Action }
...
let phantasmalForce =
    { Id = % "phantasmal-force"
      ...
      SpellDescription = "Deal 1d12 Damage/round each round on failed Saving Throw. Damage changes to last type target suffered."
      SpellLists = [ Bargained; Arcane ]
      Concentration = true
      Upcastable = true
      ActionCost = Action }
...
let phantasmalKiller =
    { Id = % "phantasmal-killer"
      ...
      SpellDescription = "Deal 1d6 psychic Damage each turn, target movement is halved. Saving Throw at the end of each round."
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let psionicAntagonism =
    { Id = % "psionic-antagonism"
      ...
      SpellDescription = "Deal 1d6+4 psychic Damage in a large AOE and prevents reaction on failed Saving Throw On Saving Throw: half damage."
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let rayOfSickness =
    { Id = % "ray-of-sickness"
      ...
      SpellDescription = "Deal 1d12+4 poison Damage, 18m range, and poison target on failed Saving Throw."
      SpellLists = [ Primal; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let rimesBindingIce =
    { Id = % "rimes-binding-ice"
      ...
      SpellDescription = "Deal 1d6+4 cold damage in a large area, and reduce movement speed by half on failed Saving Throw."
      SpellLists = [ Innate; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let seeInvisibility =
    { Id = % "see-invisibility"
      ...
      SpellDescription = "Reveal invisible tragets around you if they fail a DEX Saving Throw."
      SpellLists = [ Divine; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let shatter =
    { Id = % "shatter"
      Name = "Shatter"
      SpellDescription = "Deal 1d6+4 thunder damage in a large AOE around you, and silence targets on failed Saving Throw."
      SpellLists = [ Innate; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let sleepveil =
    { Id = % "sleepveil"
      Name = "Sleepveil"
      SpellDescription = "Every creature in a 3m AOE around you are put to sleep on failed Saving Throw."
      SpellLists = [ Primal; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let sleetStorm =
    { Id = % "sleet-storm"
      Name = "Sleet Storm"
      SpellDescription = "Disrupt concentration on failed Saving Throw in huge area. Douses fires."
      SpellLists = [ Primal; Innate ]
      Concentration = false
      Upcastable = false
      ActionCost = Action }
...
let snillocsSnowStorm =
    { Id = % "snillocs-snow-storm"
      ...
      SpellDescription = "Deal 1d12+4 cold damage in a 3m area around you. If target is Wet, apply 3 stacks of Frostbite. On Saving Throw: half damage."
      SpellLists = [ Primal; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let spewAcid =
    { Id = % "spew-acid"
      Name = "Spew Acid"
      SpellDescription = "Deal 1d12+4 acid damage in a 3m cone AOE in front of you, and afflicts targets with Acid (-2 AC) on failed Saving Throw."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let sunbeam =
    { Id = % "sunbeam"
      Name = "Sunbeam"
      SpellDescription = "Deal 1d6+4 radiant damage in a line and blind all targets on Saving Throw fail. Can cast the spell again (weakened) without expending a spell slot (free action) On Saving Throw: half damage."
      SpellLists = [ Divine; Primal ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let tashascausticBrew =
    { Id = % "tashas-caustic-brew"
      ...
      SpellDescription = "Deal 1d6+4 Acid damage in a large line and apply acid for 3 turns. On Saving Throw: half damage."
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let tashasHideousLaughter =
    { Id = % "tashas-hideous-laughter"
      ...
      SpellDescription = "Target creature is prone and can't act. Saving Throw at the end of each turn. Laughter targets now attempt a Saving Throw when taking damage."
      SpellLists = [ Bargained; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let thunderwave =
    { Id = % "thunderwave"
      Name = "Thunderwave"
      SpellDescription = "Deal 1d12+4 in a 3m cone AOE, Inflicts Reverberate and push back targets 9m on failed Saving Throw. On Saving Throw half damage."
      SpellLists = [ Innate; Arcane ]
      Concentration = false
      Upcastable = true
      ActionCost = Action }
...
let transposition =
    { Id = % "transposition"
      Name = "Transposition"
      SpellDescription = "Forcibly teleport another creature to an area you can see on failed Saving Throw."
      SpellLists = [ Divine; Innate ]
      Concentration = false
      Upcastable = false
      ActionCost = BonusAction }
...
let web =
    { Id = % "web"
      Name = "Web"
      SpellDescription = "Create a 3m AOE surface, enwebs targets on Saving Throw."
      SpellLists = [ Primal; Arcane ]
      Concentration = true
      Upcastable = true
      ActionCost = BonusAction }
