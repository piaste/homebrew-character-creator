...
let elementalWeapon =
    { Id = % "elemental-weapon"
      ...
      SpellDescription = "Enchant a weapon causing it to change its damage type to an element of your choice. You may choose from any Element upon casting. On hit, you potentially inflict a condition based on the element choosen."
      SpellLists = [ Primal; Innate ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
...
let huntersMark =
    { Id = % "hunters-mark"
      Name = "Hunter's Mark"
      SpellDescription = "When damaging the target with your weapon, roll your damage dice with advantage. You ignore Physical Resistance of your target"
      SpellLists = [ Primal; Bargained ]
      Concentration = false
      Upcastable = true
      ActionCost = BonusAction }
