...
let rec narcoleptic : TraitDef = {
    ...
    Name = "Narcoleptic"
    Grants = [
        Complex ("Narcoleptic: Sleep", "Upon starting your turn, you have a 50% chance to gain a stack of Drowsiness. Upon reaching 3 stacks, you fall Asleep.")
...
let rec reckless : TraitDef = {
    ...
    Name = "Reckless"
    Grants = [
        Complex ("Reckless: Resistance", "Ignore all damage Resistance and Immunities.")
